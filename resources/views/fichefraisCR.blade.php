            ...
            <table border="1" cellpadding="10" style="border-collapse: collapse; width: 100%;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px;"><input type="text" id="ETP" name="ETP"
                                value="{{ $ETP }}" readonly></td>
                    </tr>
                    <tr>
                        <td style="padding: 10px;">Frais Km :</td>
                        <td style="padding: 10px;"><input type="text" id="KM" name="KM"
                                value="{{ $KM }}" readonly></td>
                    </tr>
                    <tr>
                        <td style="padding: 10px;">Nuitée Hôtel :</td>
                        <td style="padding: 10px;"><input type="text" id="NUI" name="NUI"
                                value="{{ $NUI }}" readonly></td>
                    </tr>
                    <tr>
                        <td style="padding: 10px;">Repas Restaurant :</td>
                        <td style="padding: 10px;"><input type="text" id="REP" name="REP"
                                value="{{ $REP }}" readonly></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: right;">
                            <button type="button" onclick="activerModification()"
                                style="width: auto; padding: 10px;">Modifier</button>
...
<<<<<<< Updated upstream
            ...
            @if (isset($erreur))
                <div class="alert alert-danger"
                    style="background-color: #f8d7da; color: #721c24; border-color: #f5c6cb; padding: 20px;">
                    <ul style="list-style-type: none; padding: 0;">
                        @foreach ($erreur as $message)
                            <li
                                style="background-color: #f8d7da; color: #721c24; border-color: #f5c6cb; padding: 10px; border-radius: 5px; margin-bottom: 10px; font-size: 18px;">
                                {{ $message }}
                            </li>
                        @endforeach
                    </ul>
